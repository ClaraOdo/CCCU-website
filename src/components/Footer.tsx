        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#milestones" className="text-gray-300 hover:text-emerald-400 transition-colors duration-200">Mile Stones</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © 2024 Catholic Care for Children in Uganda (CCCU). All rights reserved.
            </p>
            <div className="flex items-center gap-6 text-sm text-gray-400">
              <span>Supported by U.S. Government</span>
              <span>•</span>
