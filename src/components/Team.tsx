        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {teamMembers.map((member, index) => {
            ...
            if (member.name === 'Sr. Euphrasia Masika, DST') {
              ...
              summary = `Stella-Maris Kamanzi is a Doctoral candidate pursuing a PhD in Educational Management and Administration at Makerere University’s East African School of Higher Education and Development (EASHED). She holds a Master’s Degree in Public Administration and Management from Makerere University, a Master’s Degree in Administrative Science from Tampere University in Finland, a Bachelor’s Degree in Education, and a Diploma in Teacher Training Education (Tutorship) from Kyambogo University, Uganda. Her research focuses on the funding of higher education in Africa in general, and the applicability of the Entrepreneurial University Model to Africa’s flagship universities, specifically at Makerere University, Uganda. Thus, her research is titled “The Applicability of the Entrepreneurial University Model to Makerere University-Uganda.” Stella-Maris’ academic journey and professional development have nurtured her passion for academic writing, where she excels in synthesizing complex ideas, constructing coherent arguments supported by robust evidence, and actively participating in pertinent scholarly discussions. This enthusiasm fosters critical thinking and significantly influences the trajectory of research and practices within academia. Her ORCID ID is https://orcid.org/0000-0003-0431-6339. Stella-Maris is mentored by the CODESRIA College of Mentors and is a member of the Council for the Development of Social Science Research in Africa (CODESRIA) and the African Studies Association of Africa (ASAA). She is affiliated with the Collaboration of London Graduate School and Commonwealth University in the UK. Since 2009, she has served as the National Program Coordinator of Catholic Care for Children in Uganda (CCCU), under the auspices of the Association of Religious in Uganda (ARU).\nEmail: cccucoord@aruconference.org\nPhone:+256 772 576 399\nEmail:kamanzistellamaris@gmail.com`;
